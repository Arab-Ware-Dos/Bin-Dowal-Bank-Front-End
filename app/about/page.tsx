...
export default function AboutPage() {
  ...
  const text = {
    ...
    establishmentTitle: isAr ? "النشأة والتأسيس" : "Establishment & Origins",
    establishmentParagraph1: isAr
      ? "جاء تأسيس بنك بن دول للتمويل الأصغر الإسلامي استجابةً للحاجة إلى مؤسسة مصرفية حديثة تجمع بين القيم الإسلامية الأصيلة والابتكار المالي المعاصر، وتقدّم حلولاً مالية ومصرفية ميسّرة وآمنة تراعي احتياجات مختلف شرائح المجتمع، مع تركيز خاص على الأفراد والشرائح المنتجة ورواد الأعمال والمشاريع الصغيرة والمتوسطة."
      : "Bin Dowal Islamic Microfinance Bank was established in response to the need for a modern banking institution that combines authentic Islamic values with contemporary financial innovation, offering accessible and secure financial and banking solutions tailored to the needs of diverse segments of society, with special focus on individuals, productive groups, entrepreneurs, and SMEs.",
