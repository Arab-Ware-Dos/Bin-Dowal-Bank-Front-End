  ...
  const categories = [
    {
      ...
      descEn: "Update your personal information or contact details linked to your account.",
    },
    {
      icon: FileCheck2,
      ...
      descEn: "Request bank certificates, account statements, or official letters.",
    },
    {
      icon: HelpCircle,
    ...
    },
    {
      ...
      descEn: "Request assistance with issues or challenges you face with your account.",
    },
  ]
  ...
  const processSteps = [
    {
      ...
      descEn: "Submit the details of the required service via the form in simple steps.",
    },
    {
      icon: ListChecks,
      ...
      descEn: "Review of the request by the support team to ensure requirements are complete.",
    },
    {
      icon: PhoneCall,
      ...
      descEn: "Informing the customer of the request status or need for additional information.",
    },
    {
      icon: Zap,
      titleAr: "تنفيذ الطلب",
      ...
      descEn: "Completing the service and directing the customer to receive or utilize it.",
    },
  ]
  ...
  const faqs = [
    {
      ...
      answerAr: "يمكنك طلب تحديث بياناتك، إصدار شهادات بنكية، كشوفات حساب، وغيرها من الخدمات المصرفية المباشرة.",
      answerEn: "You can request data updates, issuance of bank certificates, account statements, and other direct banking services.",
    },
    {
      id: "faq-2",
      questionAr: "هل يمكن إرفاق مستندات مع الطلب؟",
      questionEn: "Can I attach documents with the request?",
      answerAr: "نعم، يوفر النموذج خاصية إرفاق الملفات المطلوبة لمعالجة خدمتك بشكل أسرع.",
      answerEn: "Yes, the form provides a feature to attach required files to process your service faster.",
    },
    {
      id: "faq-3",
      questionAr: "كيف أتابع حالة طلبي؟",
      questionEn: "How do I track the status of my request?",
      answerAr: "سيصلك إشعار برقم مرجعي بعد التقديم، ويمكنك متابعة حالة الطلب من خلال الاتصال بخدمة العملاء.",
      answerEn: "You will receive a notification with a reference number after submission, and you can track the status by calling customer service.",
    },
    {
      id: "faq-4",
      questionAr: "هل يلزم أن أكون عميلاً لدى البنك؟",
      questionEn: "Do I need to be a customer of the bank?",
      answerAr: "بعض الخدمات تتطلب أن تكون عميلاً مسجلاً برقم حساب، بينما يمكن الاستفسار عن الخدمات دون الحاجة لحساب.",
      answerEn: "Some services require you to be a registered customer with an account number, while service inquiries can be made without an account.",
    },
  ]
                  ...
                  {formSubmitted ? (
                    ...
                    >
                      ...
                      <p className="mt-2 text-sm leading-7 text-slate-600">
                        {locale === "ar" ? "سيتم مراجعته وسنتواصل معك قريباً." : "It will be reviewed and we will contact you shortly."}
                      </p>
                    </motion.div>
                  ) : (
                    <form onSubmit={handleSubmit} className="space-y-6">
                      ...
                      <div className="grid gap-4 sm:grid-cols-2">
                        <div className="space-y-2.5">
                          <Label htmlFor="type" className="text-sm font-medium text-[#0b0d36]">
                            {locale === "ar" ? "نوع الخدمة المطلوبة" : "Required Service Type"}
                          </Label>
                          <Select required>
                            ...
                            <SelectContent>
                              <SelectItem value="update">{locale === "ar" ? "تحديث بيانات" : "Data Update"}</SelectItem>
                              <SelectItem value="document">{locale === "ar" ? "طلب مستند" : "Document Request"}</SelectItem>
                              <SelectItem value="inquiry">{locale === "ar" ? "استفسار عن خدمة" : "Service Inquiry"}</SelectItem>
                        ...
                        <div className="space-y-2.5">
                          <Label htmlFor="branch" className="text-sm font-medium text-[#0b0d36]">
                            {locale === "ar" ? "الفرع المفضل للتنفيذ" : "Preferred Branch"}
                          </Label>
                          <Select>
                            <SelectTrigger className={inputClassName}>
                            ...
                            <SelectContent>
                              <SelectItem value="main">{locale === "ar" ? "الفرع الرئيسي - المكلا" : "Main Branch - Mukalla"}</SelectItem>
                              <SelectItem value="digital">{locale === "ar" ? "عبر القنوات الرقمية" : "Via Digital Channels"}</SelectItem>
                            </SelectContent>
                          </Select>
                        </div>
                      </div>
                      ...
                      <div className="space-y-2.5">
                        <Label htmlFor="attachment" className="text-sm font-medium text-[#0b0d36]">
                          {locale === "ar" ? "مرفقات عند الحاجة" : "Attachments if needed"}
                        </Label>
              ...
              <Card className="rounded-[26px] border-none bg-white shadow-[0_18px_45px_-30px_rgba(15,23,42,0.15)] relative overflow-hidden">
                ...
                <CardContent className="p-8">
                  <h3 className="text-xl font-bold mb-4 text-[#0b0d36]">
                    {locale === "ar" ? "لماذا تستخدم هذه الخدمة؟" : "Why Use This Service?"}
                  </h3>
                  <ul className="space-y-4">
                    {[
                      { ar: "وضوح تام في مسار الطلب", en: "Complete clarity in request processing" },
                      { ar: "سهولة تنظيم المستندات وتوجيهها", en: "Easy organization and routing of documents" },
                      { ar: "متابعة أكثر ترتيبًا للنتائج", en: "More organized tracking of results" },
                      { ar: "قناة رسمية معتمدة للبنك", en: "Official approved bank channel" }
                    ].map((item, i) => (
      ...
      <section className="py-16 md:py-20 bg-white">
        <div className="container mx-auto px-4">
          <SectionTitle 
            ...
            subtitle={locale === "ar" ? "كل ما تود معرفته عن طلبات الخدمات" : "Everything you need to know about service requests"}
          />
        ...
        <div className="container mx-auto px-4">
          ...
          >
            <h2 className="text-2xl font-bold text-[#0b0d36] mb-4">
              {locale === "ar" ? "هل لديك مشكلة أو شكوى؟" : "Have an issue or complaint?"}
            </h2>
