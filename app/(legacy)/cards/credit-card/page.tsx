  ...
  return (
    <>
      <PageHero
        ...
        breadcrumbs={[{ labelKey: "nav.cards", href: "/cards" }, { labelKey: "nav.creditCards" }]}
        tagline={ar ? "البطاقات المصرفية" : "Banking Cards"}
      >
        <div className="flex flex-wrap gap-4">
          <Link href="/contact" className="inline-flex items-center gap-2 rounded-full bg-[#c9a96e] px-7 py-3.5 text-sm font-bold text-[#0b0d36] shadow-lg transition-all hover:-translate-y-0.5 hover:shadow-xl">{ar ? "اطلب البطاقة الآن" : "Request Card Now"}<ArrowRight className="h-4 w-4" /></Link>
        ...
        <div className="container mx-auto px-4">
          <motion.div variants={fadeUp} initial="hidden" whileInView="show" viewport={{ once: true }} className="mx-auto max-w-3xl text-center rounded-3xl bg-gradient-to-br from-[#0b0d36] via-[#262b80] to-[#0b0d36] px-8 py-16 shadow-[0_40px_80px_rgba(7,10,30,0.4)]">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <Link href="/contact" className="inline-flex items-center gap-2 rounded-full bg-[#c9a96e] px-7 py-3.5 text-sm font-semibold text-[#0b0d36] transition-all hover:-translate-y-0.5 hover:shadow-xl">{ar ? "اطلب البطاقة الآن" : "Request Card Now"}<ArrowRight className="h-4 w-4" /></Link>
