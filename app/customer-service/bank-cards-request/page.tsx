...
export default function CreditCardRequestPage() {
  ...
  const features = [
    ...
    },
    {
      ...
      descEn: "Enjoy a secure shopping experience with advanced protection technologies.",
    },
    {
      icon: Banknote,
  ...
  const faqs = [
    {
      ...
      answerAr: "تختلف الشروط حسب نوع البطاقة، ولكن بشكل عام يجب أن يكون لديك دخل ثابت وحساب بنكي نشط.",
      answerEn: "Requirements vary by card type, but generally you must have a steady income and an active bank account.",
    },
    {
      id: "faq-2",
      questionAr: "كم تستغرق عملية الموافقة وإصدار البطاقة؟",
      questionEn: "How long does approval and card issuance take?",
      answerAr: "عادة ما تستغرق العملية من 3 إلى 5 أيام عمل بعد استكمال كافة المستندات المطلوبة.",
      answerEn: "The process usually takes 3 to 5 business days after all required documents are completed.",
    },
    {
      id: "faq-3",
      questionAr: "هل يمكنني طلب بطاقة إذا لم يتم تحويل راتبي للبنك؟",
      questionEn: "Can I request a card if my salary is not transferred to the bank?",
      answerAr: "نعم، يمكنك ذلك بشرط تقديم إثبات دخل معتمد وتلبية المعايير الائتمانية الأخرى.",
      answerEn: "Yes, provided you submit verified proof of income and meet other credit criteria.",
    },
  ]
  ...
  return (
    <div className="min-h-screen bg-[radial-gradient(circle_at_top,rgba(38,43,128,0.05),transparent_35%),linear-gradient(to_bottom,#ffffff,#f8fafc)]">
      <PageHero
        title={locale === "ar" ? "التقديم على البطاقات الائتمانية" : "Credit Card Application"}
        subtitle={
          locale === "ar"
        ...
        breadcrumbs={[
          ...
          { labelKey: locale === "ar" ? "طلب بطاقة بنكية" : "Credit Card Request" },
        ]}
      />
          ...
          <div className="grid gap-12 lg:grid-cols-12 lg:items-start">
              ...
              <Card className="relative overflow-hidden rounded-[32px] border border-white/70 bg-white shadow-[0_28px_90px_-35px_rgba(11,13,54,0.28)]">
                ...
                <CardHeader className="relative pb-4">
                  ...
                  <CardTitle className="flex items-center gap-3 text-2xl text-[#0b0d36] md:text-[28px]">
                    ...
                    {locale === "ar" ? "تقدم بطلب الحصول على منتجات بنك بن دول" : "Apply for Bin Dowal Bank Products"}
                  </CardTitle>
                </CardHeader>
                  ...
                  {formSubmitted ? (
                    ...
                    >
                      ...
                      <h3 className="text-xl font-bold text-[#0b0d36]">
                        {locale === "ar" ? "تم استلام طلبك بنجاح" : "Application Received Successfully"}
                      </h3>
                      <p className="mt-2 text-sm leading-7 text-slate-600">
                        {locale === "ar" ? "سيقوم أحد ممثلينا بالتواصل معك في الوقت المفضل." : "One of our representatives will contact you at your preferred time."}
                      </p>
                    </motion.div>
                  ) : (
                    <form onSubmit={handleSubmit} className="space-y-8">
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="grid gap-4 sm:grid-cols-2">
                          ...
                          <div className="space-y-2.5">
                            <Label htmlFor="idNumber" className="text-sm font-medium text-[#0b0d36]">
                              {locale === "ar" ? "رقم الهوية / الإقامة" : "ID / Iqama Number"}
                            </Label>
                            <Input id="idNumber" required className={inputClassName} />
                          </div>
                        </div>

                        <div className="grid gap-4 sm:grid-cols-2">
                          <div className="space-y-2.5">
                            <Label htmlFor="cardType" className="text-sm font-medium text-[#0b0d36]">
                              {locale === "ar" ? "مهتم في اي بطاقة" : "Interested in which card"}
                            </Label>
                            <Select required>
                              <SelectTrigger className={inputClassName}>
                                <SelectValue placeholder={locale === "ar" ? "اختر البطاقة" : "Select Card"} />
                              </SelectTrigger>
                              <SelectContent>
                                <SelectItem value="credit">{locale === "ar" ? "بطاقة بن دول الائتمانية" : "Bin Dowal Credit Card"}</SelectItem>
                                <SelectItem value="prepaid">{locale === "ar" ? "بطاقة بن دول الذهبية" : "Bin Dowal Gold Card"}</SelectItem>
                                <SelectItem value="debit">{locale === "ar" ? "بطاقة نور" : "Noor Card"}</SelectItem>
                                <SelectItem value="debit">{locale === "ar" ? "بطاقة الخصم المباشر" : "Bin Dowal Debit Card"}</SelectItem>
                              </SelectContent>
                            </Select>
                          </div>

                          <div className="space-y-2.5">
                            <Label htmlFor="lang" className="text-sm font-medium text-[#0b0d36]">
                              {locale === "ar" ? "لغة التواصل المفضلة" : "Preferred Communication Language"}
                            </Label>
                            <Select required>
                              <SelectTrigger className={inputClassName}>
                                <SelectValue placeholder={locale === "ar" ? "اختر اللغة" : "Select Language"} />
                              </SelectTrigger>
                              <SelectContent>
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="grid gap-4 sm:grid-cols-2">
                          <div className="space-y-2.5">
                            <Label htmlFor="hasAccount" className="text-sm font-medium text-[#0b0d36]">
                              {locale === "ar" ? "هل لديك حساب بنكي في بنك بن دول؟" : "Do you have an account in Bin Dowal Bank?"}
                            </Label>
                            <Select required>
                              <SelectTrigger className={inputClassName}>
                          ...
                          <div className="space-y-2.5">
                            <Label htmlFor="salaryTransfer" className="text-sm font-medium text-[#0b0d36]">
                              {locale === "ar" ? "هل يتم تحويل راتبك إلى بنك بن دول؟" : "Is your salary transferred to Bin Dowal Bank?"}
                            </Label>
                            <Select required>
                              <SelectTrigger className={inputClassName}>
                                <SelectValue placeholder={locale === "ar" ? "اختر" : "Select"} />
                        ...
                        <div className="space-y-2.5 sm:w-1/2 sm:pr-2 rtl:sm:pr-0 rtl:sm:pl-2">
                          <Label htmlFor="salary" className="text-sm font-medium text-[#0b0d36]">
                            {locale === "ar" ? "كم الراتب الشهري؟" : "What is your monthly salary?"}
                          </Label>
                          <Select required>
                            <SelectTrigger className={inputClassName}>
                              <SelectValue placeholder={locale === "ar" ? "اختر" : "Select"} />
                            ...
                            <SelectContent>
                              <SelectItem value="less_5000">{locale === "ar" ? "أقل من 5,000 ريال" : "Less than 5,000 SAR"}</SelectItem>
                              <SelectItem value="5000_10000">{locale === "ar" ? "5,000 - 10,000 ريال" : "5,000 - 10,000 SAR"}</SelectItem>
                              <SelectItem value="10000_20000">{locale === "ar" ? "10,000 - 20,000 ريال" : "10,000 - 20,000 SAR"}</SelectItem>
                              <SelectItem value="more_20000">{locale === "ar" ? "أكثر من 20,000 ريال" : "More than 20,000 SAR"}</SelectItem>
                            </SelectContent>
                          </Select>
                        </div>
                      </div>
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="space-y-2.5 sm:w-1/2 sm:pr-2 rtl:sm:pr-0 rtl:sm:pl-2">
                          <Label htmlFor="bestTime" className="text-sm font-medium text-[#0b0d36]">
                            {locale === "ar" ? "أفضل وقت للاتصال بي" : "Best time to contact me"}
                          </Label>
                          <Select required>
                            <SelectTrigger className={inputClassName}>
                              <SelectValue placeholder={locale === "ar" ? "اختر الوقت المناسب" : "Select Time"} />
                            </SelectTrigger>
                            <SelectContent>
                              <SelectItem value="12am_5pm">{locale === "ar" ? "من 12:00 ص إلى 05:00 م" : "12:00 AM to 05:00 PM"}</SelectItem>
                              <SelectItem value="4am_12pm">{locale === "ar" ? "من 04:00 ص إلى 12:00 م" : "04:00 AM to 12:00 PM"}</SelectItem>
                              <SelectItem value="8pm_4pm">{locale === "ar" ? "من 08:00 م إلى 04:00 م" : "08:00 PM to 04:00 PM"}</SelectItem>
                              <SelectItem value="8am_12pm">{locale === "ar" ? "من 8:00 ص إلى 12:00 م" : "08:00 AM to 12:00 PM"}</SelectItem>
                            </SelectContent>
                          </Select>
                        </div>
                      </div>
            ...
            <motion.div {...fadeInUp} className="lg:col-span-4 space-y-6">
              {features.map((feature, index) => (
                <Card key={index} className="group relative overflow-hidden rounded-[24px] border-none bg-white shadow-sm transition-all duration-300 hover:shadow-md">
                  ...
                  <CardContent className="p-6 flex items-start gap-4">
                     ...
                     <div>
                        <h4 className="font-semibold text-[#0b0d36] mb-1">{locale === "ar" ? feature.titleAr : feature.titleEn}</h4>
                        <p className="text-sm text-slate-500 leading-relaxed">{locale === "ar" ? feature.descAr : feature.descEn}</p>
                     </div>
                  </CardContent>
                </Card>
              ))}
      ...
      <section className="py-16 md:py-20 bg-white">
        <div className="container mx-auto px-4">
          <SectionTitle 
            ...
            subtitle={locale === "ar" ? "إجابات لاستفساراتكم حول البطاقات" : "Answers to your questions about cards"}
          />
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <div className="flex flex-wrap justify-center gap-4 mt-8">
              ...
              <Link href="/customer-service/complaints">
                <Button
                  variant="outline"
                  size="lg"
                  className="h-12 rounded-xl border-[#262b80]/20 text-[#262b80] hover:bg-[#262b80]/5"
