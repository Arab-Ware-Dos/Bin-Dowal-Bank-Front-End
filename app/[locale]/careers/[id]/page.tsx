...
export async function generateMetadata({
  params
}: LocalizedJobDetailsPageProps): Promise<Metadata> {
  ...
  return {
    alternates: buildLocalizedAlternates({ pathname: `/careers/${id}`, locale: locale as "ar" | "en" }),
    title:
      locale === "ar"
...
export default async function LocalizedJobDetailsPage({
  ...
  return (
    <div data-localized-route={`careers/${id}`} data-locale={locale}>
