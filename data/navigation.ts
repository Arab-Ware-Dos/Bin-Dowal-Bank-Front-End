...
export const navigationData: NavItem[] = [
    ...
    groups: [
      {
        ...
        links: [
          { key: "currentAccount", href: "/services/current-account", label: { ar: "الحساب الجاري", en: "Current Account" }, icon: Wallet },
          { key: "savingsAccount", href: "/services/savings-account", label: { ar: "حساب التوفير", en: "Savings Account" }, icon: Wallet },
          { key: "investmentDeposits", href: "/services/investment-deposits", label: { ar: "الودائع الاستثمارية", en: "Investment Deposits" }, icon: TrendingUp },
        ]
      },
      {
        ...
        links: [
          {
            key: "localTransfers",
            href: "/services/local-transfers",
            label: { ar: "التحويلات المحلية", en: "Local Transfers" },
            icon: Send,
            subLinks: [
              { key: "doolExpress", href: "/services/dowal-express", label: { ar: "دول إكسبرس", en: "Dool Express" }, logo: "/images/partners/local/dool-express.png" },
              { key: "unifiedNetwork", href: "/services/unified-network-transfers", label: { ar: "الشبكة الموحدة", en: "UNMoney" }, logo: "/images/partners/local/unmoney.png" },
            ]
          },
          {
            key: "expressRemittances",
            href: "/services/fast-money-transfers",
            label: { ar: "الحوالات السريعة", en: "Express Remittances" },
            icon: Plane,
            cols: 1,
            subLinks: [
              { key: "moneygram", href: "/services/moneygram", label: { ar: "موني جرام", en: "MoneyGram" }, logo: "/images/partners/international/Asset 43@3x.png" },
              { key: "shift", href: "/services/shift", label: { ar: "شفت", en: "Shift" }, logo: "/images/partners/international/Shift-logo.png" },
              { key: "upt", href: "/services/upt", label: { ar: "UPT", en: "UPT" }, logo: "/images/partners/international/Asset 44@3x.png" },
              { key: "bin-yaala", href: "/services/ben-yalla", label: { ar: "بن يعلا", en: "Bin Yaala" }, logo: "/images/partners/international/Asset 46@3x.png" },
              { key: "alawneh", href: "/services/alawneh", label: { ar: "العلاونة", en: "Alawneh" }, logo: "/images/partners/international/Asset 53@3x.png" },
              { key: "zamzam", href: "/services/zamzam", label: { ar: "زمزم", en: "Zamzam" }, logo: "/images/partners/international/Asset 49@3x.png" },
              { key: "swift", href: "/services/swift-transfers", label: { ar: "سويفت", en: "Swift" }, logo: "/images/partners/international/Asset 48@3x.png" },
            ]
          },
        ]
      },
    ...
    groups: [
      {
        ...
        rows: 5,
        links: [
          { key: "corpCurrent", href: "/services/corporate-current-account", label: { ar: "حسابات مصرفية", en: "Bank Accounts" }, icon: Building2 },
          { key: "corpInvestments", href: "/services/corporate-investment-deposits", label: { ar: "الودائع الاستثمارية", en: "Investment Deposits" }, icon: TrendingUp },
          { key: "swift", href: "/services/swift-transfers", label: { ar: "حوالات السويفت", en: "SWIFT Transfers" }, icon: Globe2 },
          // { key: "credits", href: "/business#credits", label: { ar: "الاعتمادات المستندية", en: "Letters of Credit" }, icon: FileText },
          { key: "guarantees", href: "/services/bank-guarantees", label: { ar: "خطابات الضمان", en: "Letters of Guarantees" }, icon: ShieldCheck },
          { key: "payroll", href: "/services/business-banking-payroll", label: { ar: "تحويل الرواتب", en: "Payroll Management" }, icon: Users },
      ...
      //     { key: "medGuarantees", href: "/services/bank-guarantees", label: { ar: "الضمانات", en: "Guarantees" }, icon: ShieldCheck },
      ...
      // },
      {
        ...
        links: [
          ...
          { key: "smallAccounts", href: "/services/corporate-current-account", label: { ar: "حسابات الأعمال", en: "Business Accounts" }, icon: Wallet },
        ]
      }
    ]
  },
    ...
    groups: [
      {
        ...
        links: [
          { key: "expatCurrent", href: "/services/expat-account", label: { ar: "حساب المغتربين", en: "Expatriate Account" }, icon: Globe2 },
          // { key: "expatSavings", href: "/services/expat-account", label: { ar: "حسابات التوفير والودائع", en: "Savings & Investments" }, icon: HandCoins },
          // { key: "expatIntl", href: "/services/expat-account", label: { ar: "خدمات التحويل الدولي", en: "International Transfers" }, icon: Send },
          // { key: "expatLocal", href: "/services/expat-account", label: { ar: "خدمات التحويل المحلي", en: "Local Transfers" }, icon: Landmark },
      ...
      },
      {
        ...
        links: [
          { key: "minorSavings", href: "/services/minors-account", label: { ar: "حساب القاصر", en: "Minors Account" }, icon: Baby },
          // { key: "minorInvestments", href: "/services/minors-account", label: { ar: "حساب الودائع الاستثمارية", en: "Investment Deposit Account" }, icon: TrendingUp },
        ]
      },
      {
        title: { ar: "حساب نور للسيدات", en: "Noor Account (Ladies)" },
        links: [
          { key: "noorCurrent", href: "/services/noor-ladies-account", label: { ar: "حساب نور للسيدات", en: "Noor Account (Ladies)" }, icon: Wallet },
          // { key: "noorSavings", href: "/services/noor-ladies-account", label: { ar: "حسابات التوفير", en: "Savings Accounts" }, icon: HandCoins },
          // { key: "noorInvestments", href: "/services/noor-ladies-account", label: { ar: "الودائع الاستثمارية", en: "Investment Deposits" }, icon: TrendingUp },
          { key: "noorCard", href: "/services/noor-card", label: { ar: "بطاقة نور للسيدات", en: "Noor Ladies Card" }, icon: CreditCard },
      ...
      },
      {
        ...
        links: [
          // { key: "personalFinance", href: "/services/financing-personal", label: { ar: "التمويل الشخصي", en: "Personal Financing" }, icon: UserCheck },
          // { key: "realEstate", href: "/services/financing-home", label: { ar: "التمويل العقاري", en: "Real Estate Financing" }, icon: Building },
          // { key: "smallProjects", href: "/services/financing-business", label: { ar: "تمويل المشاريع الصغيرة", en: "Small Projects Financing" }, icon: Briefcase },
          { key: "financingTakamul", href: "/services/takamul-alternative-energy-financing", label: { ar: "تكامل", en: "Takamul" }, icon: Lightbulb },
          { key: "financingThimar", href: "/services/thimar-sme-financing", label: { ar: "ثمار", en: "Thimar" }, icon: TrendingUp },
          { key: "financingTaameer", href: "/services/tameer-construction-financing", label: { ar: "تعمير", en: "Ta'meer" }, icon: Building2 },
          { key: "financingNoor", href: "/services/noor-women-projects-financing", label: { ar: "نور", en: "Noor" }, icon: HeartHandshake },
          { key: "financingZad", href: "/services/zad-financing", label: { ar: "زاد", en: "Zad" }, icon: GraduationCap },
        ]
      },
      // {
      //   title: { ar: "حساب الشباب", en: "Youth Account" },
      //   links: [
      //     { key: "youthCurrent", href: "/services/youth", label: { ar: "حسابات جارية", en: "Bank Accounts" }, icon: Wallet },
      //     { key: "youthEdu", href: "/services/youth#education", label: { ar: "تمويل التعليم", en: "Education Financing" }, icon: Building2 },
  ...
  },
  {
    ...
    singleLinks: [
      ...
      { key: "internetBank", href: "/services/business-platform", label: { ar: "منصة بن دول اعمال", en: "Internet Banking" }, icon: Monitor },
      { key: "eWallet", href: "/services/e-wallet", label: { ar: "المحفظة الإلكترونية", en: "e-Wallet" },  logo: "/images/partners/pay.png" },
      { key: "posNet", href: "/services/pos-network", label: { ar: "شبكة مشترياتي", en: "Mushtarayati Network" },  logo: "/images/partners/musht.png"  },
      { key: "bankCards", href: "/services/atm-cards-services", label: { ar: "البطاقات البنكية", en: "Bank Cards" }, icon: CreditCard },
    ]
  },
  {
    key: "knowledgeCenter",
