    ...
    <div className="min-h-screen bg-[radial-gradient(circle_at_top,rgba(38,43,128,0.05),transparent_35%),linear-gradient(to_bottom,#ffffff,#f8fafc)]">
      ...
      >
        <div className="flex flex-wrap gap-3">
          ...
          <Link href={resolveHref("/contact")} className="inline-flex items-center gap-2 rounded-full border border-white/25 bg-white/10 px-6 py-3 text-sm font-bold text-white backdrop-blur-sm transition-all duration-300 hover:bg-white/20">
                ...
                <div>
                  ...
                  <div className="mt-6 grid gap-4 sm:grid-cols-3">
                    {[
                      ...
                      <Link key={i} href={resolveHref(ch.href)} className="flex items-center gap-3 rounded-2xl border border-slate-100 bg-slate-50/70 p-4 transition-all duration-200 hover:border-[#324198]/20 hover:bg-[#324198]/[0.03]">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="mt-6 grid gap-4 sm:grid-cols-3">
            {[
              ...
              <Link key={i} href={resolveHref(link.href)} className="group flex items-center justify-between rounded-[20px] border border-slate-200/80 bg-white p-5 shadow-sm transition-all duration-300 hover:border-[#324198]/20 hover:shadow-md">
                <div>
