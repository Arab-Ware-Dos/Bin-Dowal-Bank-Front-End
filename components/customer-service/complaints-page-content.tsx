...
export function ComplaintsPageContent() {
  ...
  const channels = [
    ...
    },
    {
      ...
      descEn:
        'You can visit the nearest branch and submit your complaint to our representatives.'
    },
    {
      icon: Headphones,
  ...
  const processSteps = [
    {
      ...
      descEn:
        'Registering the complaint and assigning a reference number for tracking.'
    },
    {
      icon: Search,
      titleAr: 'مراجعتها',
      ...
      descEn:
        'Studying the complaint accurately and impartially by the specialized team.'
    },
    {
      icon: MessageSquare,
      ...
      descEn:
        'Reaching out to request additional information or clarify the resolution path.'
    },
    {
      icon: RefreshCcw,
      ...
      descEn:
        'Resolving the complaint and informing the customer of the final outcome.'
    }
  ];
  ...
  const faqs = [
    {
      ...
      answerAr:
        'يمكنك تقديم الشكوى عبر تعبئة النموذج الإلكتروني في هذه الصفحة، أو زيارة أقرب فرع، أو الاتصال بخدمة العملاء.',
      answerEn:
        'You can submit a complaint by filling out the online form on this page, visiting the nearest branch, or calling customer service.'
    },
    {
      id: 'faq-2',
      ...
      answerAr:
        'نعم، سيتم تزويدك برقم مرجعي يمكنك من خلاله متابعة حالة الشكوى عبر قنوات التواصل المتاحة.',
      answerEn:
        'Yes, you will be provided with a reference number that you can use to track your complaint through available communication channels.'
    },
    {
      id: 'faq-3',
      ...
      answerAr:
        'بالتأكيد، يتيح لك النموذج الإلكتروني إرفاق المستندات التي تدعم شكواك لتسريع عملية المراجعة.',
      answerEn:
        'Certainly, the online form allows you to attach documents that support your complaint to speed up the review process.'
    },
    {
      id: 'faq-4',
      ...
      answerAr:
        'تشمل القنوات: الموقع الإلكتروني، الفروع، خدمة العملاء الهاتفية، والبريد الإلكتروني المخصص للشكاوى.',
      answerEn:
        'Channels include: the website, branches, telephone customer service, and the dedicated complaints email.'
    }
  ];
                          ...
                          <Select required>
                            ...
                            <SelectContent>
                              <SelectItem value="phone">
                                {locale === 'ar' ? 'اتصال هاتفي' : 'Phone Call'}
                              </SelectItem>
              ...
              <Card className="rounded-[26px] border-none bg-gradient-to-br from-[#0b0d36] via-[#1a2068] to-[#262b80] text-white shadow-xl overflow-hidden relative">
                ...
                <CardContent className="p-8 relative z-10">
                  ...
                  <ul className="space-y-4">
                    {[
                      {
                        ar: 'التعامل المهني والحيادي',
                        en: 'Professional and impartial handling'
                      },
                      {
                        ar: 'المتابعة المنظمة والمستمرة',
                        en: 'Organized and continuous follow-up'
                      },
                      {
                        ar: 'خصوصية وسرية المعلومات',
                        en: 'Privacy and confidentiality of information'
                      },
                      {
                        ar: 'وضوح الإجراءات والشفافية',
                        en: 'Clarity of procedures and transparency'
                      }
                    ].map((item, i) => (
      ...
      <section className="py-16 md:py-20 bg-white">
        <div className="container mx-auto px-4">
          <SectionTitle
            ...
            subtitle={
              locale === 'ar'
                ? 'إجابات لاستفساراتكم حول تقديم الشكاوى'
                : 'Answers to your questions about submitting complaints'
            }
          />
